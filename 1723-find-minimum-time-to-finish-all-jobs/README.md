<h2><a href="https://leetcode.com/problems/find-minimum-time-to-finish-all-jobs/?envType=problem-list-v2&envId=50vt8ied">1723. Find Minimum Time to Finish All Jobs</a></h2><h3>Hard</h3><hr><p>You are given an integer array <code>jobs</code>, where <code>jobs[i]</code> is the amount of time it takes to complete the <code>i<sup>th</sup></code> job.</p>
